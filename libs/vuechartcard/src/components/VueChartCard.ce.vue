...
export default defineComponent({
  props: {
    ...
    chartWidth: [String, Number] as PropType<string | number>,
    chartHeight: [String, Number] as PropType<string | number>,
  },
  setup(props) {
    ...
    onMounted(() => {
      ...
      console.log("SERIES PROP", props.serie, typeof props.serie);
